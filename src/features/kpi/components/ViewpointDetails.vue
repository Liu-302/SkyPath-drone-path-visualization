<template>
  <div class="detail-section">
    ...
    <div class="section-content">
      <div class="data-row">
        <span class="data-label">Camera Pitch / Yaw / Roll(°):</span>
        <div class="coordinate-fields">
          <div class="coordinate-field">
            <span class="coordinate-label">Pitch</span>
            <div class="coordinate-value">{{ viewpointData.pitch }}</div>
          </div>
          <div class="coordinate-field">
            <span class="coordinate-label">Yaw</span>
            <div class="coordinate-value">{{ viewpointData.yaw }}</div>
          </div>
          <div class="coordinate-field">
            <span class="coordinate-label">Roll</span>
            <div class="coordinate-value">{{ viewpointData.roll }}</div>
          </div>
        </div>
      </div>
      <div class="data-row">
